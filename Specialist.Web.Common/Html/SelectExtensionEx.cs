...
{
    public static class SelectExtensionEx {

        public static string DropDownListEx(this HtmlHelper htmlHelper, string name, string optionLabel) {
        ...
        public static string DropDownListEx(this HtmlHelper htmlHelper, string name, IEnumerable<SelectListItem> selectList, string optionLabel) {
            return DropDownListEx(htmlHelper, name, selectList, optionLabel, (IDictionary<string, object>)null);
        }

        public static string DropDownListEx(this HtmlHelper htmlHelper, string name, IEnumerable<SelectListItem> selectList, string optionLabel, object htmlAttributes) {
            return DropDownListEx(htmlHelper, name, selectList, optionLabel, new RouteValueDictionary(htmlAttributes));
        }

        public static string DropDownListEx(this HtmlHelper htmlHelper, string name) {
        ...
        public static string DropDownListEx(this HtmlHelper htmlHelper, string name, IEnumerable<SelectListItem> selectList) {
            return DropDownListEx(htmlHelper, name, selectList, (object)null /* htmlAttributes */);
        }

        public static string DropDownListEx(this HtmlHelper htmlHelper, string name, IEnumerable<SelectListItem> selectList, object htmlAttributes) {
            return DropDownListEx(htmlHelper, name, selectList, new RouteValueDictionary(htmlAttributes));
        }

        [SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters",
            Justification = "This type is appropriate for indicating a single selection.")]
        public static string DropDownListEx(this HtmlHelper htmlHelper, string name, IEnumerable<SelectListItem> selectList, IDictionary<string, object> htmlAttributes) {
            return SelectInternal(htmlHelper, null /* optionLabel */, name, selectList, false /* allowMultiple */, htmlAttributes);
        }

        [SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters",
            Justification = "This type is appropriate for indicating a single selection.")]
        public static string DropDownListEx(this HtmlHelper htmlHelper, string name, IEnumerable<SelectListItem> selectList, string optionLabel, IDictionary<string, object> htmlAttributes) {
