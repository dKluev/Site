<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<SearchVacancyVM>" %>
...
<%@ Import Namespace="Specialist.Web.Controllers.Center"%>
    ...
    <tr>
     ...
     <%= Html.DropDownList("YourCurency", new[] {
    ...
    <p> Выберите разделы для поиска:</p>
    <table>
    <tr>
    <td>
    ...
    <% } %>
      ...
      <% try
       ...
       <script language="javascript">
           window.location.href = "/client/searchvacancy/search-results-vacancy/1";
       </script>
           <% }
         }
         catch { } %>