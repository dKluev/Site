<%@ Page Title="" Language="C#" Inherits="System.Web.Mvc.ViewPage<Specialist.Web.Root.Center.ViewModels.CollectionMctsFormVM>" %>
...
<% using (Html.DefaultForm<CenterController>(c => c.CollectionMctsPost(null),
